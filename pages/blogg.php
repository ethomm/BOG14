    ...
    <section >
      <div class="row blogginnlegg">
       <article class="col-sm-8 ">
        <h2>Makes life a bit funnier</h2>
        <div class="bloggdate">fredag 4.03.2016</div>
        <img src="../images/blogg/animate.jpg" alt="Leselisten" />
        <p>Som man sier på internationalt, "I'll like to give a shout out to...". Denne uken er det <a href="https://daneden.me/" title="daniel eden">Daniel Eden</a> for hans som man også kan si på internationelt "nifty" css fil.</p>
        <p>Poenget med filen er at man med enkle grep kan ta i bruk flere forhånds animerte animasjoner. Det tok meg litt tid å åpnet døra for hvordan Daniel har tenkt. Så for at du skal slippe å tenke, tenkte jeg å gi deg fasiten med en gang...</p>
        <p>Du får noen hjelpe steg på <a href="https://github.com/daneden/animate.css">gitHub siden</a> ellers står en på egne ben, så her er en liten cook book</p>
        <p>Først legger du til css filen (dette burde du klare fint selv, ellers har vi en mye lenger vei å gå). finn et utvalgt element div, p, h1 or one you created yourself?</p>
        <p> Til class legger du til class="animated bounce" for "bounce" animasjonen eller hva enn du ønsker</p>
        <p>Steg nr 2, dine egene tillegg... I css filen kan du nå legge til for eks.  <br />
        .bounce{}<br />
        Inni dette css elementet kan du legge til animation-duration: 3s; eller delay: 4s; osv....</p>
        <p>Dette var vårt helge tips!</p>
        <p>Prekæas!!!</p>
